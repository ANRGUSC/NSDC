...
class minimize():
    ...
    def __init__(self, Average_Performance, x0, bounds, opt_mode, cooling_schedule='linear', step_max=1000, t_min=0, t_max=100, alpha=None, damping=1):
        ...
        self.cost_func = Average_Performance
        self.x0 = x0
        self.bounds = bounds[:]
