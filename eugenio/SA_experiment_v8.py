...
number_of_tasks=np.arange(10,12,2) # number of task graphs
...
#-------------------------
N=60 # main graph number of nodes/agents
...
#x0=ran.randrange(f)
x0=temp_H_list
opt = sa_v4.minimize(info,optimization_sa_v1, x0,bounds, opt_mode='continuous', step_max=100, t_max=1, t_min=0)
