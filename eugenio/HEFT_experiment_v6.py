...
import core as cor
import Network_N
import DAG_generator_scaled_v3_one_sink
...
number_of_tasks=np.arange(20,101,40) # number of task graphs

# mother network node sizes:
min_number_of_nodes=200
max_number_of_nodes=3000
step=250
...
for s in number_of_tasks:
    ...
    for t in range(0,1): # creation of a task graph
        ...
        #number of nodes.  
        G_dag,dag=DAG_generator_scaled_v3_one_sink.random_dag(nodes[t]-2,'n2')
        #plt.figure(0)
        #nx.draw(G_dag)
        #--------   
