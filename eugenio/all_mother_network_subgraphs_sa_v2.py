...
def all_mother_network_subgraphs(G,N,neighbour_number_of_nodes,Connectivity_Matrix):
    
        H_list = Network_N_sa_v1.subgraphs(G,N,neighbour_number_of_nodes)
        
        H_list_connectivities=[]
        
        i=ran.randrange(0,len(H_list))
        #for i in range(0,len(H_list)):
        print(f"{i}/{len(H_list)}")
        ...
        print("out of all mother networks")
        return H_list_connectivities
